...
d1aylH = csvread('1aylH-microvoidVSRprobe.txt');
d1cxyH = csvread('1cxyH-microvoidVSRprobe.txt');
d1mgtH = csvread('1mgtH-microvoidVSRprobe.txt');
d1moqH = csvread('1moqH-microvoidVSRprobe.txt');
d1notH = csvread('1notH-microvoidVSRprobe.txt');
d1qfmH = csvread('1qfmH-microvoidVSRprobe.txt');
d1qnfH = csvread('1qnfH-microvoidVSRprobe.txt');
d1qsaH = csvread('1qsaH-microvoidVSRprobe.txt');
d1ygeH = csvread('1ygeH-microvoidVSRprobe.txt');
d2driH = csvread('2driH-microvoidVSRprobe.txt');

data = zeros(16,3);

xlabel('R_{probe}')
ylabel('Total microvoid volume')
hold on;
for i=1:16
    data(i,1) = d1notH(i,1);
    data(i,2) = d1notH(i,2);
